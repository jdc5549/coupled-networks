...
class EpsExplProcess(ExplorationProcess):
    ...
    """
    def __init__(self, eps_deb=1.0, eps_fin=0.1, deb_expl=0, fin_expl=0.9,num_actions=1):
...
class EpsGreedy(EpsExplProcess):
    ...
    """
    def __init__(self, eps_deb=1.0, eps_fin=0.1, deb_expl=0.1, fin_expl=0.9,num_actions=1):
        super().__init__(eps_deb=eps_deb, eps_fin=eps_fin, deb_expl=deb_expl, fin_expl=fin_expl,num_actions=num_actions)
    
    def expl_action(self, policy, observation):
        return policy.random_action(observation,self.num_actions)#action_space.sample()
    
    def greedy_action(self, policy, observation):
        return policy(observation,num_actions=self.num_actions)
...
class Greedy(EpsGreedy):
    ...
    """        
    def __init__(self):
        super(Greedy, self).__init__(eps_deb=0.0, eps_fin=0.0,num_actions=1)
...
class EpsSoftmax(EpsGreedy):
    def greedy_action(self, policy, observation):
        return policy.softmax_action(observation,self.num_actions)
