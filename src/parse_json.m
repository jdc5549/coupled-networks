...
% From: http://www.mathworks.com/matlabcentral/fileexchange/20565-json-parser/content/parse_json.zip by Joel Feenstra
    ...
    while ~isempty(json)
        ...
        switch id
            case '"' % Start a name/value pair
                ...
                name = genvarname(name); %take care of non-MATLAB friendly names
                data.(name) = value;
                json = remaining_json;
